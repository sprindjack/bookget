...
linux-amd64:
	@$(MAKE) build GOOS=linux GOARCH=amd64 SUFFIX=

linux-arm64:
	@$(MAKE) build GOOS=linux GOARCH=arm64 SUFFIX=

darwin-amd64:
	@$(MAKE) build GOOS=darwin GOARCH=amd64 SUFFIX=

darwin-arm64:
	@$(MAKE) build GOOS=darwin GOARCH=arm64 SUFFIX=
